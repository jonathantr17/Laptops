...
export default function AgregarProducto() {
  const [data, setData] = useState({ title: "", specs: "", price: "" });
  ...
  const save = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    setStatus("saving");
    setMsg("Subiendo imagen y guardando...");
    try {
      let imageUrl = "";
  ...
  return (
    <div className="min-h-screen bg-[#080c10] font-['DM_Sans',sans-serif]">
      ...
      <header className="relative z-10 border-b border-white/6 px-8 py-5 flex items-center gap-3">
        ...
        <span className="font-['Bebas_Neue'] text-lg text-white tracking-wide">Agregar Producto</span>
      </header>
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-8 py-12">
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-[10px] font-medium tracking-[0.22em] uppercase text-indigo-500">Nuevo</span>
          </div>
          <h1 className="font-['Bebas_Neue'] text-5xl text-white tracking-wide leading-none">Agregar Producto</h1>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative h-56 bg-indigo-500/[0.04] border border-white/8 rounded-2xl flex items-center justify-center overflow-hidden group">
              ...
              <label className="absolute inset-0 cursor-pointer flex items-center justify-center bg-[#080c10]/70 opacity-0 group-hover:opacity-100 transition-opacity">
                <span className="text-xs text-white/60 tracking-[0.1em] uppercase">Seleccionar imagen</span>
